...
public class Dcr_Dashbord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcr_dashbord);
       ...
       // checkConnection();
        ...
        // Initialize AppData with SharedPreferences values
        initializeAppData();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.dashbordbutton) {
                    ...
                    Toast.makeText(Dcr_Dashbord.this, "DashBord View", Toast.LENGTH_SHORT).show();
        ...
        // Initialize and set up CardViews
        CardView Doctorcard = findViewById(R.id.doctor);
        Doctorcard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dcr_Dashbord.this, DoctorReport.class);
                startActivity(intent);
                finish();
            }
        });

        CardView Retailercard = findViewById(R.id.retailer);
        Retailercard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dcr_Dashbord.this, RetailerReport.class);
                startActivity(intent);
                finish();
            }
        });

        CardView ViewDcrcard = findViewById(R.id.view_DCR);
        ViewDcrcard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dcr_Dashbord.this, ViewDcrReport.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void logout() {
        ...
        Intent intent = new Intent(Dcr_Dashbord.this, MainActivity.class);
        startActivity(intent);
        finish(); // Close SecondActivity so it is removed from the back stack

        Toast.makeText(Dcr_Dashbord.this, "Successfully Logged Out", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onBackPressed() {
       /* if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
        ...
        super.onBackPressed();
        Intent intent = new Intent(Dcr_Dashbord.this, DashbordActivity.class);
        startActivity(intent);
        finish();
